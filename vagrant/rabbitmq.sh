...
# Download & install the RabbitMQ public key so apt can check signatures on the packages it installs.
...
# See https://www.rabbitmq.com/access-control.html for more info on access config.
